  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Arms - made thicker by increasing strokeWidth */}
        {/* Left arm */}
        {focusedField === 'email' ? (
          <path 
        ...
        {focusedField && (
          <g className="opacity-0 animate-fade-in">
            ...
            >
              {focusedField === 'name' ? "Your name?" :
               focusedField === 'email' ? "Email please!" :
               focusedField === 'password' ? "Keep it safe!" : ""}
            </text>
          </g>
        )}
                                ...
                                >
                                    {processing ? (
                                        ...
                                        <span className="flex items-center">
                                            Create <span className="ml-1 text-xs opacity-80">→</span>
                                        </span>
                                    )}
                                </button>
